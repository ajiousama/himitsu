...
LOCAL_LOGOS = {
    ...
    'chihou.kawasaki_keiba': venue_png('localrace_kawasaki_officialstyle.svg'),
    ...
    'chihou.nagoya_keiba': venue_png('localrace_nagoya_officialstyle.svg'),
    'chihou.sonoda': venue_png('localrace_sonoda_officialstyle.svg'),
    'chihou.himeji': venue_png('localrace_himeji_officialstyle.svg'),
    'chihou.kochi_keiba': venue_png('localrace_kochi_officialstyle.svg'),
