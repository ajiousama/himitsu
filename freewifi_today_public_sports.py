...
LOCAL_LOGOS = {
    'chihou.obihiro': venue_png('localrace_obihiro_officialstyle.svg'),
    'chihou.mombetsu': venue_png('localrace_mombetsu_officialstyle.svg'),
    'chihou.morioka': venue_png('localrace_morioka_officialstyle.svg'),
    'chihou.mizusawa': venue_png('localrace_mizusawa_officialstyle.svg'),
    'chihou.urawa': venue_png('localrace_urawa_officialstyle.svg'),
    'chihou.funabashi': venue_png('localrace_funabashi_officialstyle.svg'),
    'chihou.oi': venue_png('localrace_oi_officialstyle.svg'),
    'chihou.kawasaki_keiba': f'{RAW_BASE}/public_sports_logos_github_43/local_keiba/kawasaki.png',
    'chihou.kanazawa': venue_png('localrace_kanazawa_officialstyle.svg'),
    'chihou.kasamatsu': venue_png('localrace_kasamatsu_officialstyle.svg'),
    'chihou.nagoya_keiba': f'{RAW_BASE}/public_sports_logos_github_43/local_keiba/nagoya.png',
    'chihou.sonoda': venue_png('localrace_sonoda_officialstyle.svg'),
    'chihou.himeji': venue_png('localrace_himeji_officialstyle.svg'),
    'chihou.kochi_keiba': f'{RAW_BASE}/public_sports_logos_github_43/local_keiba/kochi.png',
    'chihou.saga': venue_png('localrace_saga_officialstyle.svg'),
